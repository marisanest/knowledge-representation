...
class JacksCarRentalEnvironmentModel(JacksCarRentalEnvironment):
    ...
    def _expected_reward_rent(self, state):
        ...
        for i in (0, 1):
            ...
            logging.logger.debug(rent_prob)
